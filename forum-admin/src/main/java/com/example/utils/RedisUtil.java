...
public class RedisUtil {
    ...
    //从ZSet中获取倒序的key
    public Set<Object> zReverseGetKeys(String key,Long start, Long end) {
        try {
    ...
    //获取zSet中key的长度
    public long zGetKeyLength(String key) {
        try {
    ...
    //判断zSet中key是否存在某个value
    public Double zHasKey(String key,Object value) {
        try {
